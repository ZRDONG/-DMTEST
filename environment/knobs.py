...
def init_knobs(instance, num_more_knobs):
    ...
    KNOB_DETAILS = {
        ...
        'HAGR_BUF_GLOBAL_SIZE': ['integer', [10, 15000, 5000]],
        'HAGR_BUF_SIZE': ['integer', [2, 8000, 500]],
        ...
        'HJ_BUF_GLOBAL_SIZE': ['integer', [10, 15000, 5000]],
        'HJ_BUF_SIZE': ['integer', [2, 8000, 1000]],
        ...
        'MEMORY_POOL': ['integer', [64, 14000, 500]],
